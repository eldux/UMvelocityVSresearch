...
for window_size = window_sizes
    ...
    folder_name = "Trained models/CNN_2layers_w" + num2str(window_size) + "/"
    mkdir(folder_name)
    ...
    fun = @(params)train_CNN_2layers(XTrain4D, YTrain4D, XValid4D, YValid4D, params, folder_name, window_size);
    results = bayesopt(fun,[conv1_units, conv1_size, conv2_units, conv2_size, fc1_units],'Verbose',1,...
