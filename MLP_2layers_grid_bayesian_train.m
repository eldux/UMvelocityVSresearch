...
for window_size = window_sizes
    ...
    folder_name = "Trained models/MLP_2layers_w" + num2str(window_size) + "/"
    mkdir(folder_name)
    ...
    fun = @(params)train_MLP_1layer(XTrain4D, YTrain4D, XValid4D, YValid4D, params, folder_name, window_size);
    results = bayesopt(fun,[fc1_units fc2_units],'Verbose',1,...
