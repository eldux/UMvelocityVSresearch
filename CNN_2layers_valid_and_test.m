...
load("Trained models/CNN_2layers_w23_69_3_1__126_10_5__94.mat");
...
% Show a graph with virtual sensor vs ground truth comparison of small part
% of signal
figure(1)
plot((0:(length(YTest_seq(1,:))-1))*0.01,YPred_seq(1,:))
hold on
plot((0:(length(YTest_seq(1,:))-1))*0.01,YTest_seq(1,:))
hold off
xlabel("Time, s")
ylabel("FL UM vertical velocity, m/s")
title("FL unsprung mass vertical velocity")
legend(["Virtual Sensor", "Ground truth"])
grid on
grid minor