function rmse = train_MLP_3layers(XTrain, YTrain, XValid, YValid, parameters, folder, window)
...
layers = [
    ...
    fullyConnectedLayer(parameters.fc3_units,"Name","fc_3")
    tanhLayer("Name","tanh_3")
    dropoutLayer(0.5,"Name","dropout")
    fullyConnectedLayer(numResponses,"Name","fc_4")
