...
save(folder + "CNN_2layers_w"+num2str(window)+'_'+num2str(parameters.conv1_units)+"_"+num2str(parameters.conv1_size)+"_"+num2str(conv1_stride(2))+"__"+num2str(parameters.conv2_units)+"_"+num2str(parameters.conv2_size)+"_"+num2str(conv2_stride(2))+"__"+num2str(parameters.fc1_units)+".mat", "net", "rmse");
