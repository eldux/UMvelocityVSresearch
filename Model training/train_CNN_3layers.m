function rmse = train_CNN_3layers(XTrain, YTrain, XValid, YValid, parameters, folder, window)
...
conv3_stride = [1 floor(parameters.conv3_size/2)];
...
layers = [
    ...
    convolution2dLayer([1 parameters.conv3_size], parameters.conv3_units,"Name","conv_3","Padding","same", "Stride", conv3_stride)
    leakyReluLayer(0.1,'Name','leaky_3')
